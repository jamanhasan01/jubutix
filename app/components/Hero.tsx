...
>
  {heading}
          ...
          <motion.div
            ...
            className='w-full md:w-2/5 h-[500px] flex items-center justify-center relative'
          >
            <BlobShape />
            ...
            <InfoCard
              ...
              className='top-8 right-0' // Position top-right
            />
            <InfoCard
              variants={itemVariants}
            ...
            <InfoCard
              ...
              className='bottom-10 right-1/4' // Position bottom-ish
            />
          </motion.div>
        </motion.div>
      </div>
